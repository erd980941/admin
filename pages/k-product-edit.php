            ...
            <div class="card-body">
                ...
                <form action="../_business/k-product.request.php" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="k_category_id" class="form-select" required>
                            ...
                            <?php foreach($categories as $category): ?> 
                                <option value="<?php echo $category['k_category_id'] ?>" <?php echo $category['k_category_id']==$product['k_category_id']?'selected':'' ?> ><?php echo $category['category_name'] ?></option>
                            <?php endforeach; ?>                           
                        </select>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="product_link" value="<?php echo $product['product_link'] ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="product_short_description" value="<?php echo $product['product_short_description'] ?>" >
                    </div>
                    ...
                    <div class="d-grid gap-2 mt-2">
                        <button type="submit" name="edit_k_product" class="btn btn-primary">Kaydet</button>
                    </div>
                </form>
            </div>
        </div>
